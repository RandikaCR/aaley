...
class FrontendController extends Controller
{
    ...
    public function testMail(Request $request)
    {
        ...
        return view('frontend.test-mail', ['data' => $data]);
    }
}
