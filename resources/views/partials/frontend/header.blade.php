<header class="transparent-header">
    ...
    <div class="offCanvas-wrap">
        <div class="offCanvas-toggle"><img src="{{ asset('assets/frontend/img/icons/close.png') }}" alt="icon"></div>
    ...
    <div class="mini__cart-wrap">
        <div class="mini__cart-toggle"><img src="{{ asset('assets/frontend/img/icons/close.png') }}" alt="icon"></div>
            ...
            <div class="mini__cart-widget">
                <div class="mini__cart-item">
                    ...
                    <div class="mini__cart-delete">
                        <img src="{{ asset('assets/frontend/img/icons/close.png') }}" alt="icon">
                    </div>
                </div>
            </div>
        </div>
