<footer class="footer__area footer__bg" data-background="{{ asset('assets/frontend/img/bg/footer_bg.jpg') }}">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer__widget">
                        <div class="footer__logo">
                            <a href="{{ url('/') }}"><img src="{{ asset('assets/common/images/logo-white.png') }}" alt="logo"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer__widget">
                        ...
                        <div class="footer__payment">
                            <img src="{{ asset('assets/frontend/img/images/payment.svg') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
