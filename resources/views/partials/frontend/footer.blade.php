<footer class="footer__area footer__bg" data-background="{{ asset('assets/common/images/footer_bg.jpg') }}">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="footer__widget">
                        ...
                        <ul class="list-wrap footer__social">
                            <li>
                                <a href="https://www.facebook.com/AaleyCeylon" target="_blank">
                            ...
                            <li>
                                <a href="https://www.instagram.com/aaley_ceylon" target="_blank">
