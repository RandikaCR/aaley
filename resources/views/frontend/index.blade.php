    ...
    <section class="slider__area">
        ...
        <div class="slider__social-wrap">
            ...
            <ul class="list-wrap slider__social">
                <li>
                    <a href="https://www.facebook.com/AaleyCeylon" class="al-text-primary" target="_blank">
                ...
                <li>
                    <a href="https://www.instagram.com/aaley_ceylon" class="al-text-primary" target="_blank">
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
