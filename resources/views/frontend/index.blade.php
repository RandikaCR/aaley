...
@section('content')
    ...
    <section class="about__area-two section-py-150">
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-10">
                    <div class="about__img-two" data-sal="slide-right" data-sal-duration="700" data-sal-delay="100">
                        <img src="{{ asset('assets/frontend/img/images/h2_about_img.jpg') }}" alt="img">
                        <div class="marquee__wrap">
                            <div class="slider__marquee clearfix marquee-wrap">
                                <div class="marquee_mode marquee__group">
                                    <h6 class="marquee__item">unique formulation</h6>
                                    <h6 class="marquee__item">heritage of quality</h6>
                                    <h6 class="marquee__item">natural ingredients</h6>
                                    <h6 class="marquee__item">bone builder</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="about__content-two">
                        <div class="section__title mb-30">
                            <span class="sub-title">TRUSTED SINCE 1980</span>
                            <h2 class="title">Our formulas are crafted with trusted natural ingredients that support total wellness.</h2>
                        </div>
        ...
        <div class="about__shape-two">
            <img src="{{ asset('assets/frontend/img/images/faq_shape.png') }}" alt="shape" data-sal="slide-left" data-sal-duration="700" data-sal-delay="100">
        </div>
    </section>

    <section class="about__area section-pt-150 section-pb-120">
        <div class="container">
